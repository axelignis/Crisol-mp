...
<required_reading>
@$HOME/crisol/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@$HOME/crisol/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = $HOME/crisol/.claude
                  → checks $HOME/crisol/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = $HOME/crisol/.claude/get-shit-done
                  → writes to $HOME/crisol/.claude/get-shit-done/hooks/
...
@$HOME/crisol/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @$HOME/crisol/.claude/get-shit-done/references/common-bug-patterns.md
