...
<execution_context>
@$HOME/crisol/.claude/get-shit-done/workflows/add-todo.md
@$HOME/crisol/.claude/get-shit-done/workflows/note.md
@$HOME/crisol/.claude/get-shit-done/workflows/add-backlog.md
@$HOME/crisol/.claude/get-shit-done/workflows/plant-seed.md
@$HOME/crisol/.claude/get-shit-done/workflows/check-todos.md
