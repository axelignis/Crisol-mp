...
<execution_context>
@$HOME/crisol/.claude/get-shit-done/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @$HOME/crisol/.claude/get-shit-done/workflows/mvp-phase.md end-to-end.
