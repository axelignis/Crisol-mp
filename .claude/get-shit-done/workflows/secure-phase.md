...
```
Agent(
  prompt="Read $HOME/crisol/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `$HOME/crisol/.claude/get-shit-done/templates/SECURITY.md`
