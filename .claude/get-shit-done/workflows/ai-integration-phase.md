...
<required_reading>
@$HOME/crisol/.claude/get-shit-done/references/ai-frameworks.md
@$HOME/crisol/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read $HOME/crisol/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "$HOME/crisol/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read $HOME/crisol/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read $HOME/crisol/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read $HOME/crisol/.claude/agents/gsd-eval-planner.md for instructions.
