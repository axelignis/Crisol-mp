...
```markdown
Read $HOME/crisol/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: $HOME/crisol/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read $HOME/crisol/.claude/agents/gsd-ui-checker.md for instructions.
