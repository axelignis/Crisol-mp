...
Key references:
- @$HOME/crisol/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @$HOME/crisol/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @$HOME/crisol/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="$HOME/crisol/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "$HOME/crisol/.claude/get-shit-done/USER-PROFILE.md" "$HOME/crisol/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at $HOME/crisol/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `$HOME/crisol/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @$HOME/crisol/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to $HOME/crisol/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to $HOME/crisol/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at $HOME/crisol/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at $HOME/crisol/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to $HOME/crisol/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="$HOME/crisol/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    $HOME/crisol/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   $HOME/crisol/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        $HOME/crisol/.claude/CLAUDE.md
```
