...
```bash
INIT=$(node "$HOME/crisol/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @$HOME/crisol/.claude/get-shit-done/templates/spec.md.
