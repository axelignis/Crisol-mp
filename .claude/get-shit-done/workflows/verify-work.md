...
<template>
@$HOME/crisol/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@$HOME/crisol/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `$HOME/crisol/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @$HOME/crisol/.claude/get-shit-done/workflows/diagnose-issues.md
