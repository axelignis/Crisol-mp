...
<!-- For checkpoint task examples and patterns, see @$HOME/crisol/.claude/get-shit-done/references/checkpoints.md -->
...
See `$HOME/crisol/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `$HOME/crisol/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `$HOME/crisol/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
